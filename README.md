...
它不仅仅是生成单词卡，还支持**听写训练**和**口语回译**，真正实现“听说读写”全方位提升。同时，本项目支持mac和手机上的日间与黑夜模式。

![背诵卡正面](images/lightcard1.png)
![背诵卡背面](images/nightcard1.png)
...
![card](images/ListenCardFront.png)

![card](images/ListenCardBack.png)
...
![card](images/SpokenCardFrontlight.png)

![card](images/SpokenCardBack.png)
